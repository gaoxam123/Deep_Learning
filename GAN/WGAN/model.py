...
class Discriminator(nn.Module):
    def __init__(self, channels_img, features_d): # N * channels_img * 64 * 64
        super().__init__()
...
class Generator(nn.Module):
    def __init__(self, z_dim, channels_img, features_g):
        ...
        self.gen = nn.Sequential(
            ...
            self.block(z_dim, features_g * 16, kernel_size=4, stride=1, padding=0), # N x features_g * 16 x 4 x 4
