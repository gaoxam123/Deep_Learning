...
class Transformer:
    ...
    def normalize(self, image):
        ...
        mean = torch.tensor(self.image_mean, dtype, device)
        std = torch.tensor(self.image_std, dtype, device)
    ...
    def postprocess(self, res, image_shape, ori_image_shape):
        box = res['boxes']
